...
namespace 入梦方舟小工具
{
    partial class 入梦方舟小工具 : Form
    {
        ...
        {
          Process.Start("https://www.bianshengruanjian.com/index.php/archives/6/");
        ...
        private void 初始化配置常量()
        {
            ...
            checkBox4.Text = "后台模式";
            API.写配置项(功能配置路径, "Set", "houtai", "1");//后台模式当前
            checkBox26.Checked = true;
            // API.写配置项(功能配置路径, "Set", "checkBox26", "1");
            ...
            去除树叶灌木.Checked = false;
            去除水下致盲.Checked = true;
            关闭折射.Checked = true;
            地图表面覆盖光.Checked = true;
            关闭天空效果.Checked = true;
            覆盖反射效果.Checked = true;
            纯地形模式.Checked = false;
            除雾.Checked = true;
            关闭粒子系统.Checked = true;
            水面遮挡移除.Checked = false;
            去除远处景深.Checked = true;
            API.写配置项(功能配置路径, "Set", "60FPS", "0");          
            API.写配置项(功能配置路径, "Set", "去除树叶灌木", "0");
            API.写配置项(功能配置路径, "Set", "关闭折射", "1");
            API.写配置项(功能配置路径, "Set", "去除水下致盲", "1");
            API.写配置项(功能配置路径, "Set", "地图表面覆盖光", "1");
            API.写配置项(功能配置路径, "Set", "关闭天空效果", "1");
            API.写配置项(功能配置路径, "Set", "覆盖反射效果", "1");
            API.写配置项(功能配置路径, "Set", "纯地形模式", "0");
            API.写配置项(功能配置路径, "Set", "除雾", "1");
            API.写配置项(功能配置路径, "Set", "关闭粒子系统", "1");
            API.写配置项(功能配置路径, "Set", "水面遮挡移除", "0");
            API.写配置项(功能配置路径, "Set", "去除远处景深", "1");
        ...
        {       
            ...
            else
            {
                ...
                if (API.读配置项(功能配置路径, "Set", "checkBox26") == "1")
                {
                    checkBox26.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "checkBox23") == "1")
                {
                    checkBox23.Checked = true;

                }
                if (API.读配置项(功能配置路径, "Set", "checkBox24") == "1")
                {
                    checkBox24.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "checkBox25") == "1")
                {
                ...
                if (API.读配置项(功能配置路径, "Set", "去除树叶灌木") == "1")
                {
                    去除树叶灌木.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "去除水下致盲") == "1")
                {
                    去除水下致盲.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "关闭折射") == "1")
                {
                    关闭折射.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "地图表面覆盖光") == "1")
                {
                    地图表面覆盖光.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "关闭天空效果") == "1")
                {
                    关闭天空效果.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "覆盖反射效果") == "1")
                {
                    覆盖反射效果.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "纯地形模式") == "1")
                {
                    纯地形模式.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "除雾") == "1")
                {
                    除雾.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "关闭粒子系统") == "1")
                {
                    关闭粒子系统.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "水面遮挡移除") == "1")
                {
                    水面遮挡移除.Checked = true;
                }
                if (API.读配置项(功能配置路径, "Set", "去除远处景深") == "1")
                {
                    去除远处景深.Checked = true;
                }
        ...
        private void 初始化()
        {
            ...
            label94.Text = He.ToString() + "x" + Wi.ToString();
        ...
        private void 时钟检测软件_Tick(object sender, EventArgs e)
        {
            ...
            if (API.进程_是否存在("ShooterGame") == true)
            {
                ...
                {
                    方舟未运行.Text = "方舟已运行";
                    label17.Text = "入梦方舟小工具: " + 方舟未运行.Text+ " (" + label94.Text+ ")";
                }
                else
                {
                    方舟未运行.Text = "方舟已运行(隐藏)";
        ...
        {
            severnumber = API.网页_访问("http://a.bianshengruanjian.com/ARK/Ver.txt");//读取服务器最新版本 
            try
            {
                配置初始化();
                初始化();
        ...
        private void button8_Click_2(object sender, EventArgs e)//转载战斗画质1
        {
            try
            {
        ...
        private void button11_Click_1(object sender, EventArgs e)//转载战斗画质2
        {
            try
            {
                string txt = API.读配置项(游戏路径, "Set", "Path");
        ...
        {
            API.网页_打开指定网址("http://www.teandy.com/resource/Gen1-1.html");
        }
        ...
        private void checkBox26_CheckedChanged(object sender, EventArgs e)
        {
            ...
            API.写配置项(功能配置路径, "Set", "checkBox26", "1");
            API.写配置项(功能配置路径, "Set", "checkBox23", "0");
            API.写配置项(功能配置路径, "Set", "checkBox24", "0");
            API.写配置项(功能配置路径, "Set", "checkBox25", "0");
            buy1.BackgroundImage = Properties.Resources.crosshair_625px_1231391_easyicon_net;
        }
        ...
        private void checkBox23_CheckedChanged(object sender, EventArgs e)
        {
            ...
            API.写配置项(功能配置路径, "Set", "checkBox26", "0");
            API.写配置项(功能配置路径, "Set", "checkBox24", "0");
            API.写配置项(功能配置路径, "Set", "checkBox25", "0");
            API.写配置项(功能配置路径, "Set", "checkBox23", "1");
            try
            {
                buy1.BackgroundImage = Image.FromFile(Environment.CurrentDirectory + "\\RM\\绿靶子.png");
            }
            catch
            {
                buy1.BackgroundImage = Properties.Resources.crosshair_625px_1231391_easyicon_net;
        ...
        private void checkBox24_CheckedChanged(object sender, EventArgs e)
        {
            ...
            API.写配置项(功能配置路径, "Set", "checkBox26", "0");
            API.写配置项(功能配置路径, "Set", "checkBox24", "1");
            API.写配置项(功能配置路径, "Set", "checkBox25", "0");
            API.写配置项(功能配置路径, "Set", "checkBox23", "0");
            try
            {
                buy1.BackgroundImage = Image.FromFile(Environment.CurrentDirectory + "\\RM\\红十字.png");
            }
            catch
            {
                buy1.BackgroundImage = Properties.Resources.crosshair_625px_1231391_easyicon_net;
        ...
        private void checkBox25_CheckedChanged(object sender, EventArgs e)
        {
            ...
            API.写配置项(功能配置路径, "Set", "checkBox26", "0");
            API.写配置项(功能配置路径, "Set", "checkBox24", "0");
            API.写配置项(功能配置路径, "Set", "checkBox25", "1");
            API.写配置项(功能配置路径, "Set", "checkBox23", "0");
            try
            {
                buy1.BackgroundImage = Image.FromFile(Environment.CurrentDirectory + "\\RM\\红点.png");
            }
            catch
            {
                buy1.BackgroundImage = Properties.Resources.crosshair_625px_1231391_easyicon_net;
        ...
        private void 去除树叶灌木_CheckedChanged(object sender, EventArgs e)
        {
            if (去除树叶灌木.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "去除树叶灌木", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "去除树叶灌木", "0");
        ...
        private void 关闭折射_CheckedChanged(object sender, EventArgs e)
        {
            if (关闭折射.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "关闭折射", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "关闭折射", "0");
            }
        }

        private void 去除水下致盲_CheckedChanged(object sender, EventArgs e)
        {
            if (去除水下致盲.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "去除水下致盲", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "去除水下致盲", "0");
            }
        }

        private void 地图表面覆盖光_CheckedChanged(object sender, EventArgs e)
        {
            if (地图表面覆盖光.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "地图表面覆盖光", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "地图表面覆盖光", "0");
            }
        }

        private void 关闭天空效果_CheckedChanged(object sender, EventArgs e)
        {
            if (关闭天空效果.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "关闭天空效果", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "关闭天空效果", "0");
            }
        }

        private void 覆盖反射效果_CheckedChanged(object sender, EventArgs e)
        {
            if (覆盖反射效果.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "覆盖反射效果", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "覆盖反射效果", "0");
            }
        }
        private void 纯地形模式_CheckedChanged(object sender, EventArgs e)
        {
            if (纯地形模式.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "纯地形模式", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "纯地形模式", "0");
        ...
        private void 除雾_CheckedChanged(object sender, EventArgs e)
        {
            if (除雾.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "除雾", "1");
            ...
            {
                API.写配置项(功能配置路径, "Set", "除雾", "0");
            }
        }
        private void 关闭粒子系统_CheckedChanged(object sender, EventArgs e)
        {
            if (关闭粒子系统.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "关闭粒子系统", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "关闭粒子系统", "0");
            }
        }
        private void 水面遮挡移除_CheckedChanged(object sender, EventArgs e)
        {
            if (水面遮挡移除.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "水面遮挡移除", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "水面遮挡移除", "0");
        ...
        private void 去除远处景深_CheckedChanged(object sender, EventArgs e)
        {
            if (去除远处景深.Checked == true)
            {
                API.写配置项(功能配置路径, "Set", "去除远处景深", "1");
            }
            else
            {
                API.写配置项(功能配置路径, "Set", "去除远处景深", "0");
            }
        }

        private void 确定战斗画质_Click(object sender, EventArgs e)
        {
            try
            {
                string txt = API.读配置项(游戏路径, "Set", "Path");
                ...
                if (txt != "")
                {
                    ...
                    if (纯地形模式.Checked == true)
                    {
                        API.WritePrivateProfileString("Startup", "ShowFlag.Selection", "0", txt);//纯地形模式，移除植被，全部资源消失
                    }
                    if (去除水下致盲.Checked == true)
                    {
                    ...
                    if (除雾.Checked == true)
                    {
                        API.WritePrivateProfileString("Startup", "ShowFlag.StaticMeshes", "0", txt);//除雾
                    }
                    if (关闭粒子系统.Checked == true)
                    {
                    ...
                    if (水面遮挡移除.Checked == true)
                    {
                        API.WritePrivateProfileString("Startup", "ShowFlag.GameplayDebug", "0", txt);//水面遮挡移除             
                    }
                    if (去除远处景深.Checked == true)
                    {
